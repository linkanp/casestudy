 ...
 */
class QuestionEditForm extends QuestionFormBase {
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['submit']['#value'] = $this->t('Update '.$submit_text);
    $actions['delete']['#url'] = Url::fromRoute('entity.question.delete_form', ['casestudy' => $path_args[4],'question'=> $path_args[6]]);
    return $actions;
  }

 ...
 */
class TabDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete tab %label?', [
  ...
  public function getCancelUrl() {
    ...
    return new Url('entity.casestudy.tab_settings_form', ['casestudy' => $path_args[4]]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Tab %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));

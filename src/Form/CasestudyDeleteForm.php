 ...
 */
class CasestudyDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete casestudy %label?', [
  ...
  public function getConfirmText() {
    return $this->t('Delete Casestudy');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.casestudy.list');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('Casestudy %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));

 ...
 */
class CasestudyTabSettingsForm extends EntityForm {
...
//            ]);
        ...
        foreach ($elements as $key => $element) {
            ...
            if($elementObj) {
                ...
                $rows[$elementObj->id()] = $this->getElementRow($elementObj, $delta);
            }
        }
        $form['tabs'] = [
                '#type' => 'table',
...
//    exit;
      ...
      //print_r($casestudy);
    $casestudy->setTabs($casestudy->get('tabs'));
      //print_r($casestudy);
      //echo 'herere'; exit;
...
//    exit;
    ...
    if ($status == SAVED_UPDATED) {
      ...
      drupal_set_message($this->t('Tab Settings for casestudy %label has been updated.', ['%label' => $casestudy->label()]));
    ...
    // Redirect the user back to the listing route after the save operation.
      $url = Url::fromRoute('entity.casestudy.tab_settings_form', ['casestudy' => $casestudy->id()]);

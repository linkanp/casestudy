 ...
 * @ingroup webform
 */
class CasestudySubmissionListBuilder extends EntityListBuilder {
  ...
  public function __construct(EntityTypeInterface $entity_type, EntityStorageInterface $storage) {
    ...
    /** @var CasestudySubmissionStorageInterface $webform_submission_storage */
  ...
  protected function getQuery($keys = '', $state = '') {
    /** @var \Drupal\webform\CasestudySubmissionStorageInterface $submission_storage */

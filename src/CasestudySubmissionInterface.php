 ...
 */
interface CasestudySubmissionInterface extends ContentEntityInterface, EntityOwnerInterface {
  ...
  /**
   * Gets the casestudy submission's casestudy entity.
   *
   * @return \Drupal\casestudy\Entity\Casestudy
   *   The casestudy entity.
   */
